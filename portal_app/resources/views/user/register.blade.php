...
<div id="wrapper">
    ...
    <div class="container-fluid px-4 mt-4 ">
        ...
        <div class="row gx-2 gy-3 mt-3 ">
            <!-- News Block -->
            <div class="col-md-5">
                <form id="registerForm" method="POST" enctype="multipart/form-data" autocomplete="off" action="{{route('register')}} class="form-floating">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <label for="ced">Centro de Custo</label>
                    </div>
                    <div class="form-floating mb-5">
                        ...
                        <label for="permission">Selecione o nivel permissão</label>
                    </div>
