                ...
                <div class="card bg-dark-alt text-white " style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-0 pb-0">
                            <div>
                                <img src="{{asset('assets/logo/lowcost.svg')}}">
                            </div>
                            ...
                            @endif
                            <form id="formLogin" method="POST" action="{{route('password-recover')}}" autocomplete="off" >
                                @csrf
                                <div data-mdb-input-init class="form-outline form-white mb-4" style="text-align: left !important;">
                                    <label class="form-label" for="typeEmpresaX" style="display: none">Empresa</label>
                                    <input type="text" id="typeEmpresaX"  name="typeEmpresaX" class="form-control form-control-lg " autocomplete="off"  placeholder="Empresa" required/>
                                </div>
                                ...
                                <div data-mdb-input-init class="form-outline form-white mb-4 " style="text-align: left !important; display: none">
                                    <div class="input-group mb-0">
                                        <input type='password'  autocomplete="off" class="form-control myInput form-control-lg" placeholder="Password" id="typePasswordX"
                                    ...
                                    <div class="form-check ml-auto text-left pt-2" style="text-align: left !important; display: none">
